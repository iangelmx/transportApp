...
$urlBase = "https://maps.google.com/maps/api/geocode/json?key=YOUR_API_KEY&address=";
...
$unidadesDisponibles = $api->doQuery("SELECT
    placa, distancia, (capacidad-ocupabilidad) as 'lugares', v.idUnidad as 'idUnidad', u.chofer
        ...
        <div class="content mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    foreach($unidadesDisponibles as $unidad) {
                                        echo ' 
                                        <a>
                                        <section data="'.$unidad['idUnidad'].'" class="card" onclick="muestraDatos(this)" id=" '. $unidad['placa'] .' ">
                                ...
                                <input type="hidden" value="" name = "unidadSelected" id = "unidadSelected"/>
                                <input type="hidden" value="" name = "idUnidadSel" id = "idUnidadSel"/>
                                                                    <!-- <div class="col-md-4"> -->
            ...
            <script type="text/javascript">
                function muestraDatos(element){
                    ...
                    jQuery("#idUnidadSel").val(element.getAttribute("data"));
