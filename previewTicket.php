...
$url = "https://maps.googleapis.com/maps/api/distancematrix/json?key=API_KEY&units=metric&origins=".$coordA."&destinations=".$coordB;
...
if( $distanciaAB > 4000 ){
    $costo += intval( (($distanciaAB-4000)/1000)*1);
}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="./ticket.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <input type="hidden" name="idUnidadSel" value="<?php echo $idUnidadSel;?>">
                                    ...
                                    <button type="submit" class="btn btn-success"><i class="fa fa-cc-paypal"></i>&nbsp; Finalizar compra</button>
